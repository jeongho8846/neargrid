// 📄 src/features/thread/lists/HubThread_ChildThreadList.tsx
...
import { useReadHubThreadChildThreads } from '../hooks/useReadHubThreadChildThreads';
...
const HubThread_ChildThreadList: React.FC<Props> = ({
  ...
  const {
    ...
    refetch,
    isFetching,
  } = useReadHubThreadChildThreads(threadId, member?.id);
...
export default HubThread_ChildThreadList;
