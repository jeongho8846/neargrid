 ...
 */
export const getDonationRankThreadByDonor = async ({
  currentMemberId,
  threadId,
  cursorMark,
}: {
  ...
  console.log('📥 getDonationRankThreadByDonor 호출됨');
  ...
  try {
    ...
    console.log('📥 [RES] getDonationRankThreadByDonor 성공:', res.data);
    ...
    console.error('❌ [ERR] getDonationRankThreadByDonor:', {
